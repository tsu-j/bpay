...
var apiUtils = require('@moralisweb3/api-utils');
    ...
    function ClientEvmApi() {
        ...
        _this.nft = {
            ...
            searchNFTs: function (request) {
                return new apiUtils.PaginatedOperationResolver(commonEvmUtils.searchNFTsOperation, _this.baseUrl, _this.core).fetch(request);
            },
        ...
        _this.token = {
            getErc20Approvals: function (request) {
                return new apiUtils.PaginatedOperationResolver(commonEvmUtils.getErc20ApprovalsOperation, _this.baseUrl, _this.core).fetch(request);
            },
            getErc20Burns: function (request) {
                return new apiUtils.PaginatedOperationResolver(commonEvmUtils.getErc20BurnsOperation, _this.baseUrl, _this.core).fetch(request);
            },
            getErc20Transfers: function (request) {
                return new apiUtils.PaginatedOperationResolver(commonEvmUtils.getErc20TransfersOperation, _this.baseUrl, _this.core).fetch(request);
            },
            getErc20Mints: function (request) {
                return new apiUtils.PaginatedOperationResolver(commonEvmUtils.getErc20MintsOperation, _this.baseUrl, _this.core).fetch(request);
            },
