import Core, { ConfigKey, Operation, ResponseAdapter, PaginatedRequest, PaginatedOperation, PaginatedResponseAdapter, OperationV3, Core as Core$1, Pagination, Module } from '@moralisweb3/common-core';
...
declare class OperationV3Resolver<Request, RequestJSON, Response, ResponseJSON, Body, BodyJSON> {
    ...
    private readonly core;
    private readonly requestController;
    constructor(operation: OperationV3<Request, RequestJSON, Response, ResponseJSON, Body, BodyJSON>, baseUrl: BaseUrlOrResolver<Request>, core: Core$1);
